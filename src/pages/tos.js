    ...
    return (
        <Layout>
            <div className="tosCont">
                ...
                <p className="textTos miniText">{t('tos.l11')}<a href="https://www.termsofservicegenerator.net">{t('tos.l11-1')}</a>&nbsp; {t('tos.l11-2')} &nbsp; <a href="https://www.generateprivacypolicy.com">{t('tos.l11-3')}</a>.</p>
                ...
                <p className="textTos">{t('tos.l23')} <Link to="/privacy">{t('tos.l23-1')}</Link>.</p>
