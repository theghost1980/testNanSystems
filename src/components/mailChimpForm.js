...
// 1. Ya no necesitas gatsby-plugin-mailchimp
...
const NetlifyForm = (props) => {
    ...
    const _handleSubmit = async (e) => {
        ...
        try {
            ...
            // Si el fetch no da error, asumimos éxito
            setData({
                ...data,
        ...
        data.result.result === "empty" ? (
            <div className="coloredScreenBGFixed relativeDiv">
                <div className="subcriptionCont" id="confettyDiv">
                    <img src={imgSubcription} alt="subscribe" className="imgSubscriptions" />
                    
                    {/* Atributos necesarios para Netlify */}
                    <form 
                    ...
                    >
                        ...
                        />
                        <br />
                        <button name="btnSubscribe" className="btnSubscribe xtraSubscribeBtn" type="submit">
                            {t('subscribe.getme')}
                        </button>
                    </form>
        ...
        data.result.result === "success" ? (
            ...
            <div className="coloredScreenBGFixed">
                <div className="subcriptionCont">
                    ...
                    <div className="divErrorSubcriptions">
                        <p>{t('subscribe.error')} <a href="/contact">{t('subscribe.error2')}</a>.</p>
                    </div>
                    <div className="btnSubscribeMini positionAbs1 " onClick={() => closeCB()}>
                        Close
                    </div>
